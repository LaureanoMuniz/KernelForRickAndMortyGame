...
#define C_BG_LIGHT_BLUE    (0x9 << 4)
#define C_BG_LIGHT_GREEN   (0xA << 4)
#define C_BG_LIGHT_CYAN    (0xB << 4)
#define C_BG_LIGHT_RED     (0xC << 4)
#define C_BG_LIGHT_MAGENTA (0xD << 4)
#define C_BG_LIGHT_BROWN   (0xE << 4)
