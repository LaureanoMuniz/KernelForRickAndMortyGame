...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.6]{img/IDTdescriptor.pdf}
	\caption{Esquema de descriptor de la IDT}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{img/TssdescriptorManual.pdf}
...
%figura tareas sin Rick y Morty
\justify
